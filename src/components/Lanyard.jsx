...
export default function Lanyard({
  ...
  fov = 20,
  transparent = true,
  frontImage = './pictura-flyer.jpg',
  backImage = './pictura-flyer.jpg',
  lanyardWidth = 1
}) {
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          >
            {/* Card Mesh Geometry with Front/Back Textures */}
            <mesh position={[0, 0, 0]}>
            ...
            {/* Metallic Clip & Clamp Top Attachment */}
            <mesh position={[0, 0.58, 0]}>
              <boxGeometry args={[0.18, 0.08, 0.04]} />
              <meshStandardMaterial color="#FF5500" metalness={0.9} roughness={0.2} />
            </mesh>
